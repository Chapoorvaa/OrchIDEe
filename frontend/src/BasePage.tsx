...
export const HomePage: React.FC = () => {
  return (
    <>
      <div className="m-0 grid h-screen w-screen grid-cols-[50px_300px_1fr_300px_50px] grid-rows-[50px_1fr_repeat(2,50px)] gap-2">
        <div className="col-span-5">Status bar</div>
        <div className="col-start-1 row-start-2">Tree and Git buttons</div>
        <div className="col-start-2 row-start-2">Git or Tree</div>
