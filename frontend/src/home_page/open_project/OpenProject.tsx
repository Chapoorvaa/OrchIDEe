...
const OpenProject: React.FC<OpenProjectProps> = ({
  ...
  return (
    <div className="flex flex-col justify-center m-auto drop-shadow-lg rounded-xl border-2 border-skin-stroke-light bg-skin-bg-dark text-skin-text-primary h-1/3 w-2/5">
